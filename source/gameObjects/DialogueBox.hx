...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		handSelect = new FlxSprite(1042, 590).loadGraphic(Paths.image('stages/weeb/pixelUI/hand_textbox'));
		...
		swagDialogue.sounds = [FlxG.sound.load(Paths.sound('pixel/pixelText'), 0.6)];
		add(swagDialogue);
