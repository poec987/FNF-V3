...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		rating = new FlxSprite().loadGraphic(Paths.image(Paths.getSkinPath() + 'sick'));
		...
		{
			var numScore:FlxSprite = new FlxSprite(43 * daLoop).loadGraphic(Paths.image(Paths.getSkinPath() + 'num' + i));
		...
		timeBarBG = new FlxSprite(0, timeTxt.y + 8).loadGraphic(Paths.image(Paths.getSkinPath() + 'timeBar'));
